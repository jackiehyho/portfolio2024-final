const id = "fannypax.md";
						...
						const data = {title:"FannyPax",isDraft:false,pubDate:"Tue Jun 30 2015",projectDuration:"3 days",description:"Let’s have more fun & less fuss with FannyPAX",role:"Product Manager",thumbnail:
						new Proxy({"src":"/_astro/placeholder.CKewEcQe.png","width":600,"height":400,"format":"png","fsPath":"/Users/jackieho/portfolio2024-final-1/src/images/portfolio/fannypax/placeholder.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/jackieho/portfolio2024-final-1/src/images/portfolio/fannypax/placeholder.png";
							}
