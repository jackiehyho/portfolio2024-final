const id = "four-seasons-rv-rental.md";
						...
						const data = {title:"Four Seasons RV Rentals",isDraft:false,pubDate:"Sun May 31 2020",projectDuration:"8 Weeks (Jan 2019 - Feb 2019)",description:"Reimagination of Four Seasons RV Rental",roles:["Due to limited resources, I took on various roles as product manager, art director, product designer, web developer and digital marketer to ensure that the product is complete and delivered on time."],team:[{name:"Phoenix Maclaren",position:"Project Manager & Content Writer"},{name:"Gurjant Sekhon",position:"Graphic & Production Designer"}],processes:[{src:
