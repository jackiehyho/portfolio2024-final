const id = "5-elements-of-ux-design.md";
						const collection = "blogs";
						const slug = "5-elements-of-ux-design";
						...
						const data = {title:"5 Elements of UX Design",isDraft:true,pubDate:"Mon Jan 08 2024",description:"Jesse James Garrett",author:"Jackie Ho",thumbnail:
					...
					,alt:"goodbye",category:"UX Design"};
						const _internal = {
							type: 'content',
							filePath: "/Users/jackieho/portfolio2024-final-1/src/content/blogs/5-elements-of-ux-design.md",
							rawData: undefined,
						};
