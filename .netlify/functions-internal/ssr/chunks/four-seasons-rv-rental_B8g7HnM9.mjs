const id = "four-seasons-rv-rental.md";
						...
						const data = {title:"Four Seasons RV Rentals By Fraserway RV",isDraft:false,pubDate:"Sun May 31 2020",projectDuration:"8 Weeks",description:"Reimagination of Four Seasons RV Rental",roleSummary:"For this project, due to limited resources, I wore many hats and took on the following roles in order to deliver the project on time.",roles:["Product Manager","Art Director","Product Designer","Wordpress Developer","Digital Marketer"],team:[{name:"Phoenix Maclaren",position:"Project Manager & Content Writer"},{name:"Gurjant Sekhon",position:"Graphic & Production Designer"}],processes:[{src:
					...
					,header:"Research & Discovery",activities:["Stakeholder Interviews","Competitor Research","Platform Research","Product Strategy"]},{src:
					...
					,header:"User & Systems Testing",activities:["User Acceptance Testing","Smoke Testing"]},{src:
					...
					,header:"Go-to-Market Strategy",activities:["Google Tag Manager Setup","Google Analytics Setup","Custom Events"]}],thumbnail:
