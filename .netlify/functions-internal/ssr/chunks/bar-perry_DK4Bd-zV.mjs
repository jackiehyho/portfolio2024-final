const id = "bar-perry.md";
						const collection = "portfolio";
						const slug = "bar-perry";
						...
						const data = {title:"Bar Perry Photography",isDraft:false,pubDate:"Mon Jun 29 2015",projectDuration:"1 Week",description:"Creating a brand identity for a local pet photographer.",role:"Graphic Designer",thumbnail:
						new Proxy({"src":"/_astro/BarPerry.BFPhA3jR.png","width":600,"height":400,"format":"png","fsPath":"/Users/jackieho/portfolio2024-final-1/src/images/portfolio/bar-perry/BarPerry.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/jackieho/portfolio2024-final-1/src/images/portfolio/bar-perry/BarPerry.png";
							}
