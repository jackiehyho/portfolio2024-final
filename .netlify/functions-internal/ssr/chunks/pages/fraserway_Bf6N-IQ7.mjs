import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as renderComponent, e as createAstro, f as addAttribute, g as defineStyleVars, h as renderSlot, i as renderHead } from '../astro_49uZQKwN.mjs';
import 'kleur/colors';
/* empty css                         */
import 'clsx';
...
}, "/Users/jackieho/portfolio2024-final-1/src/components/SocialMedia.astro", void 0);
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$2 || (_a$2 = __template$2(["", `<footer class="container-footer" data-astro-cid-sz7xmlte> <section class="contact-section" data-astro-cid-sz7xmlte> <div class="contact-intro" data-astro-cid-sz7xmlte> <h2 id="contact" class="contact-title" data-astro-cid-sz7xmlte>Got a project or idea? Let's Connect!</h2> <p class="contact-description" data-astro-cid-sz7xmlte>
Fill out the form below & I'll get back to you as soon as possible.
</p> </div> <form class="contact-form" action="https://api.web3forms.com/submit" method="POST" data-astro-cid-sz7xmlte> <input type="hidden" name="access_key" value="c9b8e3fe-39ce-4afa-9000-7bda3b721d42" data-astro-cid-sz7xmlte> <input type="hidden" name="subject" value="New Contact Form Submission from Web3Forms" data-astro-cid-sz7xmlte> <input type="hidden" name="from_name" value="My Website" data-astro-cid-sz7xmlte> <!-- More custom ization options available in the docs: https://docs.web3forms.com --> <div class="form-group-container" data-astro-cid-sz7xmlte> <div class="form-group" data-astro-cid-sz7xmlte> <input id="name" name="name" class="form-input" placeholder="Your Name" type="text" data-astro-cid-sz7xmlte> </div> <div class="form-group" data-astro-cid-sz7xmlte> <input id="email" name="email" class="form-input" placeholder="Your Email" type="email" data-astro-cid-sz7xmlte> </div> <div class="form-group" data-astro-cid-sz7xmlte> <input id="phone" name="phone" class="form-input" placeholder="+1 (123) 456-7890" type="text" data-astro-cid-sz7xmlte> </div> <div class="form-group" data-astro-cid-sz7xmlte> <textarea class="form-textarea" id="message" name="message" placeholder="Your Message" data-astro-cid-sz7xmlte></textarea> </div> </div> <button class="primary-button" type="submit" data-astro-cid-sz7xmlte>Send Message</button> </form> </section> `, ' <p id="footer-copyright" data-astro-cid-sz7xmlte><small data-astro-cid-sz7xmlte> ', "<br data-astro-cid-sz7xmlte>", ` &copy; <span id="currentYear" data-astro-cid-sz7xmlte></span></small> </p> </footer>  <script>
...
<\/script>`])), maybeRenderHead(), renderComponent($$result, "SocialMedia", $$SocialMedia, { "data-astro-cid-sz7xmlte": true }), footerText, copyrightText);
}, "/Users/jackieho/portfolio2024-final-1/src/components/Footer.astro", void 0);
...
const $$Navigation = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", `<button id="menuToggle" class="mobile-button" data-astro-cid-pux6a34n>Menu</button> <nav id="mobileMenu" class="mobile-menu" role="navigation" data-astro-cid-pux6a34n> <ul class="nav-list" data-astro-cid-pux6a34n> <li class="nav-list-item" data-astro-cid-pux6a34n> <a id="nav-home-URL" class="nav-list-link" href="/" aria-label="Link to Homepage & Portfolio" data-astro-cid-pux6a34n>Work</a> </li> <li class="nav-list-item" data-astro-cid-pux6a34n> <a id="nav-blog-url" class="nav-list-link" href="/my-experiences" aria-label="Link to Blog" data-astro-cid-pux6a34n>My Experiences</a> </li> <li class="nav-list-item" data-astro-cid-pux6a34n> <a id="nav-blog-url" class="nav-list-link" href="/blog" aria-label="Link to Blog" data-astro-cid-pux6a34n>Blog</a> </li> <!-- <li class="nav-list-item">
      <a id="nav-blog-url" class="nav-list-link" href="/services" aria-label="Link to Blog">Services</a>
    </li> --> <li class="nav-list-item" data-astro-cid-pux6a34n> <a id="nav-linkedin-url" class="nav-list-link" href="#contact" data-astro-cid-pux6a34n>Let's Connect</a> </li> </ul> </nav> <script>
...
}, "/Users/jackieho/portfolio2024-final-1/src/components/Navigation.astro", void 0);
...
}, "/Users/jackieho/portfolio2024-final-1/src/components/Logo.astro", void 0);

const $$Header = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<header data-astro-cid-3ef6ksr2> ${renderComponent($$result, "Logo", $$Logo, { "data-astro-cid-3ef6ksr2": true })}${renderComponent($$result, "Navigation", $$Navigation, { "data-astro-cid-3ef6ksr2": true })} </header> `;
}, "/Users/jackieho/portfolio2024-final-1/src/components/Header.astro", void 0);
...
}, "/Users/jackieho/portfolio2024-final-1/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en"', '> <head><meta charset="UTF-8"><meta name="description"', `><meta name="viewport" content="width=device-width" initial-scale="1"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><!-- Google Tag Manager --><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
		...
		<\/script><!-- End Google Tag Manager --><link href="https://fonts.googleapis.com/css2?family=Dosis:wght@200..800&display=swap" as="style" rel="preload"><meta name="generator"`, "><title>", "</title>", "", "</head> <body", '> <!-- Google Tag Manager (noscript) --> <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-53X4K6H" height="0" width="0"', "></iframe></noscript> <!-- End Google Tag Manager (noscript) --> ", " ", " ", " </body></html>"])), addAttribute($$definedVars, "style"), addAttribute(description, "content"), addAttribute(Astro2.generator, "content"), title, renderComponent($$result, "ViewTransitions", $$ViewTransitions, {}), renderHead(), addAttribute($$definedVars, "style"), addAttribute(`${"display:none;visibility:hidden"}; ${$$definedVars}`, "style"), renderComponent($$result, "Header", $$Header, {}), renderSlot($$result, $$slots["main"]), renderComponent($$result, "Footer", $$Footer, { "name": "footer", "footerText": "Hand-coded by Jackie Ho, powered by Astro Build!", "copyrightText": "All Rights Reserved" }));
}, "/Users/jackieho/portfolio2024-final-1/src/layouts/Layout.astro", void 0);
...
}, "/Users/jackieho/portfolio2024-final-1/src/pages/fraserway.astro", void 0);

const $$file = "/Users/jackieho/portfolio2024-final-1/src/pages/fraserway.astro";
const $$url = "/fraserway";

const fraserway = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    default: $$Fraserway,
    file: $$file,
    prerender,
...
export { $$Layout as $, fraserway as f };
