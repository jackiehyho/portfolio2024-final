...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", '<footer class="container-footer" data-astro-cid-sz7xmlte> ', ' <p id="footer-copyright" data-astro-cid-sz7xmlte><small data-astro-cid-sz7xmlte> ', "<br data-astro-cid-sz7xmlte>", ` &copy; <span id="currentYear" data-astro-cid-sz7xmlte></span></small> </p> </footer>  <script>
...
const $$Navigation = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<button id="menuToggle" class="mobile-button" data-astro-cid-pux6a34n>Menu</button> <nav id="mobileMenu" class="mobile-menu" role="navigation" data-astro-cid-pux6a34n> <ul class="nav-list" data-astro-cid-pux6a34n> <li class="nav-list-item" data-astro-cid-pux6a34n> <a id="nav-home-URL" class="nav-list-link" href="/" aria-label="Link to Homepage & Portfolio" data-astro-cid-pux6a34n>Work</a> </li> <li class="nav-list-item" data-astro-cid-pux6a34n> <a id="nav-blog-url" class="nav-list-link" href="/my-experiences" aria-label="Link to Blog" data-astro-cid-pux6a34n>My Experiences</a> </li> <li class="nav-list-item" data-astro-cid-pux6a34n> <a id="nav-blog-url" class="nav-list-link" href="/blog" aria-label="Link to Blog" data-astro-cid-pux6a34n>Blog</a> </li> <!-- <li class="nav-list-item">
      <a id="nav-blog-url" class="nav-list-link" href="/services" aria-label="Link to Blog">Services</a>
    </li> --> <li class="nav-list-item" data-astro-cid-pux6a34n> <a id="nav-linkedin-url" class="nav-list-link" href="https://www.linkedin.com/in/jackiehyho/" data-astro-cid-pux6a34n>Let's Connect</a> </li> </ul> </nav>  `;
